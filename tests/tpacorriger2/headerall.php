...
<nav class="navbar navbar-inverse">
  <div class="container-fluid" style="position: relative;">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="http://localhost/messenmage.000webhostapp.com/Beta/Site(En%20Beta)/">MessenMage</a>
    </div>

    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
      <ul class="nav navbar-nav">
        <li><a href="MessenMageChat.php">Chat</a></li>
        <li><a href="">Se Connecter/Creé Un Compte</a></li>
      ...
      <form class="navbar-form navbar-left" role="search">
        <div class="form-group">
          <input type="text" name="search" class="form-control" size="15" placeholder="Search">
        </div>
        <button type="submit" class="btn btn-default">Rechercher</button>
      </form>
      <ul class="nav navbar-nav navbar-right">
        <li><a href="mailto:Dalkiaaahotmail.com9@gmail.com">Me Contacter</a></li>
      </ul>
   </div>
   </div> 
  </div>
...
<style type="text/css">.ChangeProjetoforange
{
