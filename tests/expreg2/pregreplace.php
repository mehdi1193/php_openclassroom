<?php
// BB code
$texte = "[b][i]gras et italique[/i][/b], Ce [color=blue]texte[/color]  est [b]important[/b], http://google.com il faut me [b]comprendre[/b]";
$gras = preg_replace('#\[b\](.+)\[/b\]#isU', '<strong>$1</strong>', $texte);
$italique = preg_replace('#\[i\](.+)\[/i\]#', '<em>$1</em>', $gras);
$color = preg_replace('#\[color=(red|green|blue|yellow|purple|olive)\](.+)\[/color\]#isU', '<span style="color:$1">$2</span>', $italique);
$lien = preg_replace('#http://[a-z0-9._/-]+#i', '<a href="$0">$0</a>', $color);
echo $lien;
?>
